...
public class RecorderDeleteListener extends RecorderRestListenerAbstract implements RecorderRestAPI {

	
	public RecorderDeleteListener(RecorderService service, String uri, Map<String, String[]> parameters) {
		super(service, uri, parameters);
	}

	@Override
	public void onRecorder() throws UnsupportedRestOperation,
			RestOperationException, MissingParameterRestOperation {
		throw new UnsupportedRestOperation(getUri(), Verb.DELETE);
	}

	@Override
	public void onType(String type) throws UnsupportedRestOperation,
			RestOperationException, MissingParameterRestOperation {
		throw new UnsupportedRestOperation(getUri(), Verb.DELETE);
	}
