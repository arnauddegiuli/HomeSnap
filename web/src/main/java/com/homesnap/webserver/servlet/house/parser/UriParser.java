...
*/
      ...
      if (jj_2_27(2)) {
        if (jj_2_24(2)) {
          ...
          if (jj_2_7(2)) {
            ...
            if (jj_2_4(2)) {
              jj_consume_token(18);
              where = jj_consume_token(ID);
              if (jj_2_1(2)) {
                automation();
                                                                              {if (true) return;}
              } else if (jj_2_2(2)) {
                light(where.toString());
                                                                                         {if (true) return;}
              } else if (jj_2_3(2)) {
                jj_consume_token(0);
  ...
  final public void light(String where) throws ParseException, UnsupportedRestOperation, RestOperationException, MissingParameterRestOperation {
    if (jj_2_33(2)) {
      jj_consume_token(18);
      if (jj_2_31(2)) {
        jj_consume_token(ON);
        jj_consume_token(0);
                                    onLightStatus(where, LightStatusValue.LIGHT_ON);
      } else if (jj_2_32(2)) {
        jj_consume_token(OFF);
        jj_consume_token(0);
                                     onLightStatus(where, LightStatusValue.LIGHT_OFF);
      } else {
        jj_consume_token(-1);
        throw new ParseException();
      }
  ...
  final public void automation() throws ParseException {
    jj_consume_token(18);
    if (jj_2_36(2)) {
      jj_consume_token(UP);
      jj_consume_token(0);
                           System.out.println("volet UP");
    } else if (jj_2_37(2)) {
      jj_consume_token(DOWN);
      jj_consume_token(0);
                             System.out.println("volet DOWN");
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
