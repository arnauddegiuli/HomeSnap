...
//		}
	...
	public String createActionMessage(State newWhat, Where where, Who who) {
		...
		// TODO manage mapping
		String what = newWhat.getValue().getValue();
		// TODO manage who code
		return MessageFormat.format(Command.COMMAND, new Object[] {who.name(), what, where.getTo()}); 
	}
	...
	public String createStatusMessage(StateName what, Where where, Who who) {
		...
		// TODO manage who code
		return MessageFormat.format(Command.STATUS, new Object[] {who.name(), where.getTo()});
