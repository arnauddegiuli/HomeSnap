...
public class EditControllerActivity extends AbstractActivity {
	...
	private static enum Controllers {
		...
		public Class<? extends Controller<? extends Status>> getControllerClass() {
			return clazz;
		}
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sControllerType.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> parent, View view,
				...
				try {
					newController = myDomoService.createController(controllerEnum.getControllerClass(), null);
				} catch (Exception e) {
		...
		btnSave.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try {
					...
					Group group = getGroup(getHouse(), selectedGroupId, true);
